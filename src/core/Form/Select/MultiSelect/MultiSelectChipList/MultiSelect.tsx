...
interface MultiSelectDataObj<T extends MultiSelectData> {
  [key: string]: T;
}
...
> {
  ...
  render() {
    ...
    const filteredItemsObj: MultiSelectDataObj<
      T & MultiSelectData & CheckedProp
    > = Object.assign({}, ...selectedItems);
    Object.keys(selectedItems).forEach((key) => {
      filteredItemsObj[key].checked = true;
    });
                      ...
                      return (
                        <MultiSelectItem
                          ...
                          key={`${item.uniqueItemId}_${
                            filteredItemsObj[item.uniqueItemId].checked
                          }`}
                          id={`${id}-${item.uniqueItemId}`}
                          checked={filteredItemsObj[item.uniqueItemId].checked}
